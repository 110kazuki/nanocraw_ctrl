#ifndef _ROS_nanocraw_ctrl_CrawlerCmd_h
#define _ROS_nanocraw_ctrl_CrawlerCmd_h
...
namespace nanocraw_ctrl
{
  ...
  class CrawlerCmd : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "nanocraw_ctrl/CrawlerCmd"; };
